...
#define IDC_EDIT_DETECTION_PERCENTAGE								40003
#define IDC_EDIT_DETECTION_SCALE									40004
#define IDC_EDIT_DETECTION_INTERVAL									40005
#define IDC_BUTTON_CHANGE_DETECTION									40006
#define IDC_BUTTON_REQUEST_CONFIGINFO								40007
